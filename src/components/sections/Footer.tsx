  ...
  return (
    <footer className="border-t border-border py-9">
      <div className="w-full max-w-content mx-auto px-8 flex items-center justify-between gap-6 flex-wrap max-[680px]:flex-col max-[680px]:items-start">
        <div className="font-mono text-[13.5px] text-muted-2">
          Mitchell Sam <span className="text-accent mx-1">·</span> New York, NY
        </div>
        <div className="flex items-center gap-2.5">
          <a
            ...
            aria-label="GitHub"
            className="w-[38px] h-[38px] flex items-center justify-center border border-border rounded-[9px] text-muted transition-all hover:text-accent hover:border-accent/30 hover:bg-accent-dim"
          >
          ...
          <a
            href="https://linkedin.com/in/mitchell-sam"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="w-[38px] h-[38px] flex items-center justify-center border border-border rounded-[9px] text-muted transition-all hover:text-accent hover:border-accent/30 hover:bg-accent-dim"
          ...
          <a
            href="/resume.pdf"
            download
            className="font-mono text-[13px] text-muted-2 pl-4 ml-1.5 border-l border-border transition-colors hover:text-accent"
          >
            Download Resume (PDF)
          </a>
        </div>
